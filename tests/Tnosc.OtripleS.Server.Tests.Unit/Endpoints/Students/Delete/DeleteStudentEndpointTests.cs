...
public partial class DeleteStudentEndpointTests : RESTFulController
{
    private readonly IStudentService _studentService;
    private readonly DeleteStudentEndpoint _deleteStudentEndpoint;

    public DeleteStudentEndpointTests()
    {
        _studentService = Substitute.For<IStudentService>();
        _deleteStudentEndpoint = new DeleteStudentEndpoint(studentService: _studentService);
    }
