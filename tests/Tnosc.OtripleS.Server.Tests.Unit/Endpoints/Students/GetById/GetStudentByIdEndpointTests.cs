...
public partial class GetStudentByIdEndpointTests : RESTFulController
{
    private readonly IStudentService _studentService;
    private readonly GetStudentByIdEndpoint _getStudentByIdEndpoint;

    public GetStudentByIdEndpointTests()
    {
        _studentService = Substitute.For<IStudentService>();
        _getStudentByIdEndpoint = new GetStudentByIdEndpoint(studentService: _studentService);
    }
