...
public partial class GetStudentsEndpointTests : RESTFulController
{
    private readonly IStudentService _studentService;
    private readonly GetStudentsEndpoint _getStudentsEndpoint;

    public GetStudentsEndpointTests()
    {
        _studentService = Substitute.For<IStudentService>();
        _getStudentsEndpoint = new GetStudentsEndpoint(studentService: _studentService);
    }
