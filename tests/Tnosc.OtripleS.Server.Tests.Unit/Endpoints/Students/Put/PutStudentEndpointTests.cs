...
public partial class PutStudentEndpointTests : RESTFulController
{
    private readonly IStudentService _studentService;
    private readonly PutStudentEndpoint _putStudentEndpoint;

    public PutStudentEndpointTests()
    {
        _studentService = Substitute.For<IStudentService>();
        _putStudentEndpoint = new PutStudentEndpoint(studentService: _studentService);
    }
