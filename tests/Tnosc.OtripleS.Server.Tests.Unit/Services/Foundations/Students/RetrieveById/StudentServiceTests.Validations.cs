...
{
    [Fact]
    public async Task ShouldThrowValidationExceptionOnRetrieveStudentByIdWhenIdIsInvalidAndLogItAsync()
    {
        // given
    ...
    [Fact]
    public async Task ShouldThrowNotFoundExceptionOnRetrieveStudentByIdIfStudentIsNotFoundAndLogItAsync()
    {
        //given
